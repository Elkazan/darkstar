...
FISHING_GUILD_POINTS      = 10.000; -- Multiplies guild points earned from fishermans' guild trades.
WOODWORKING_GUILD_POINTS  = 10.000; -- Multiplies guild points earned from carpenters' guild trades.
SMITHING_GUILD_POINTS     = 10.000; -- Multiplies guild points earned from blacksmiths' guild trades.
GOLDSMITHING_GUILD_POINTS = 10.000; -- Multiplies guild points earned from goldsmiths' guild trades.
CLOTHCRAFT_GUILD_POINTS   = 10.000; -- Multiplies guild points earned from weavers' guild trades.
LEATHERCRAFT_GUILD_POINTS = 10.000; -- Multiplies guild points earned from tanners' guild trades.
BONECRAFT_GUILD_POINTS    = 10.000; -- Multiplies guild points earned from boneworkers' guild trades.
